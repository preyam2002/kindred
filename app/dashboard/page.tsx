  ...
  const ratingCards = [
    {
      ...
      count: ratedCounts.overall,
      type: "all",
    },
    {
      label: "Books",
      value: ratingSummary.books,
      count: ratedCounts.books,
      type: "book",
    },
    {
      label: "Anime",
      value: ratingSummary.anime,
      count: ratedCounts.anime,
      type: "anime",
    },
    {
      label: "Manga",
      value: ratingSummary.manga,
      count: ratedCounts.manga,
      type: "manga",
    },
    {
      label: "Movies",
      value: ratingSummary.movies,
      count: ratedCounts.movies,
      type: "movie",
    },
    {
      label: "Music",
      value: ratingSummary.music,
      count: ratedCounts.music,
      type: "music",
    },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {quickActions.map(
            ({ title, description, href, icon: Icon, color }) => {
              ...
              const badgeBg = `hsl(var(--${color}) / 0.14)`;
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {[
            {
              label: "Books",
              count: stats.media.books,
              icon: BookOpen,
              type: "book",
            },
            {
              label: "Anime",
              count: stats.media.anime,
              icon: Tv,
              type: "anime",
            },
            {
              label: "Manga",
              count: stats.media.manga,
              icon: BookOpen,
              type: "manga",
            },
            {
              label: "Movies",
              count: stats.media.movies,
              icon: Film,
              type: "movie",
            },
            {
              label: "Music",
              count: stats.media.music,
              icon: Music,
              type: "music",
            },
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (
                        ...
                        fallback.innerHTML = `<div class="text-4xl">${
                          rec.media.type === "book"
                            ? "📚"
                            : rec.media.type === "movie"
                            ? "🎬"
                            : rec.media.type === "music"
                            ? "🎵"
                            : "📺"
                        }</div>`;
            ...
            {recentActivity.slice(0, 5).map((activity) => (
              ...
              >
                {activity.media_items?.poster_url ? (
                  <img
                    src={
                      normalizePosterUrl(activity.media_items.poster_url) || ""
                    }
